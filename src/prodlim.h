...
void prodlim_clustersurv(double *y,int *status,int *cluster,int *NC,double *time,double *nrisk,double *cluster_nrisk,int *nevent,int *loss,int *ncluster_with_event,int *sizeof_cluster,int *nevent_in_cluster,double *surv,double *hazard,double *varhazard,double *adj1,double *adj2,double *adjvarhazard,int *t,int start,int stop);
